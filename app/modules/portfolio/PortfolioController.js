...
function PortfolioCtrl ($scope) {
	...
	$scope.urls = [
		...
		},
		{
			...
			// desc: 'This site is raw PHP without a framework. It was done in PHP4 by others. I was hired to bring it up to date in PHP 5, and also to build the landing page animation. It takes a bit to load, and is missing the original spinner, but it works.'
		},
		{
